...
<%@ page language="java" contentType="text/html;charset=UTF-8" %>
    ...
    <style>
	    body{
		 /* background: url(http://muscarelle.org/wp-content/uploads/2014/11/Newspapers.jpg) no-repeat center center fixed;*/
		  background: url(http://www.meh.ro/original/2009_09/meh.ro1162.jpg) no-repeat center center fixed;
...
<body class="page page-id-5158 page-child parent-pageid-4739 page-template-default wpb-js-composer js-comp-ver-4.4.2 vc_responsive" data-backtext="Back" data-vm-anim="1">
    <div id="mk-boxed-layout">
        <div id="mk-theme-container" class="mk-transparent-header">
		                ...
		                <div class="mk-grid header-grid">
		                    <div class="mk-header-nav-container one-row-style menu-hover-style-5">
		                        <nav id="mk-main-navigation" class="main_menu">
		                            <ul id="menu-main-navigation" class="main-navigation-ul">
		                                <li id="menu-item-5110" class="menu-item current-menu-ancestor"><a class="menu-item-link" href="../main.htm/?query=general">커버스토리</a></li>
		                                <li id="menu-item-23" class="menu-item"><a class="menu-item-link" href="../">모아보기</a></li>
										<li id="menu-item-24" class="menu-item"><a class="menu-item-link" href="#">관련기사</a></li>
		                            </ul>
		                        </nav>
		                    ...
		                    <div class="header-logo  logo-has-sticky">
		                        <a href="../" title="Jupiter Wordpress Theme ">
		                            <img class="mk-desktop-logo dark-logo" alt="Jupiter Wordpress Theme " src="<c:url value="/resources/images/logo3.png"/>" style="height:25px;">
		                            <img class="mk-desktop-logo light-logo" alt="Jupiter Wordpress Theme " src="<c:url value="/resources/images/logo3.png"/>" style="height:25px;">
		                        </a>
		                    </div>
		    ...
		    <div style="height:100vh; background-color:#252525; opacity:0.5;"></div>
    		<p style="font-size:60pt; position:absolute; color:#fff; top:40vh; left:75vh;">404 page <br/> &nbsp;&nbsp;ㅋㅋㅋ</p>
